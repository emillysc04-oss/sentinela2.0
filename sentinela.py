...
# CSS Atualizado: Identidade Visual HCPA (Verde #008542)
ESTILO = """
  ...
  /* Cabeçalho Verde HCPA */
  .header { background: #008542; color: white; padding: 20px; text-align: center; letter-spacing: 1px; }
  .header h3 { margin: 0; font-size: 18px; text-transform: uppercase; }
  
  .section { padding: 25px; border-bottom: 1px solid #eee; }
  
  /* Borda lateral Verde */
  .section-title { font-size: 13px; font-weight: bold; color: #444; text-transform: uppercase; margin-bottom: 15px; border-left: 4px solid #008542; padding-left: 10px; }
  
  ul { padding: 0; list-style: none; margin: 0; }
  li { margin-bottom: 15px; padding-bottom: 15px; border-bottom: 1px solid #f0f0f0; }
  
  /* Links em Verde HCPA */
  a { color: #008542; text-decoration: none; font-weight: 600; font-size: 15px; }
  ...
  /* Tag PDF Verde */
  .pdf-tag { font-size: 9px; color: #008542; border: 1px solid #008542; padding: 1px 4px; border-radius: 3px; margin-left: 5px; vertical-align: middle; }
...
if __name__ == "__main__":
    ...
    <body>
        <div class='box'>
            ...
            {corpo}
            <div class='footer'>Relatório Automático Diário • Hospital de Clínicas de Porto Alegre</div>
        </div>
    </body></html>
    """
